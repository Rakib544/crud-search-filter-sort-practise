  ...
  useEffect(() => {
    const filterUser = users.filter((user) =>
      user.name
        .toLowerCase()
        .includes(
          searchedData.name.toLowerCase() ||
            searchedData.email.toLocaleLowerCase() ||
            searchedData.website.toLocaleLowerCase()
        )
    );
    ...
    <div className="pt-24 text-center md:px-12 overflow-x-scroll">
      ...
      <div className="flex justify-between">
        <div className="flex justify-center">
          <button className="btn" onClick={() => handleSorted("asc")}>
            ASC
          </button>
          <button className="btn" onClick={() => handleSorted("dsc")}>
            DSC
          </button>
        </div>
        <div>
      ...
      <div className="flex justify-center">
        {pageNumbers.map((pageNumber) => (
          <button
            className="px-4 py-2 bg-primary text-white mx-2"

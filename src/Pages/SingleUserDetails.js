...
const SingleUserDetails = () => {
  ...
  return (
    <div className="pt-24 px-12">
      <h2 className="pb-2 font-bold text-lg border-b-2 border-primary">
        User Details
      </h2>
      <div className="py-4">
        <h3>
        ...
        <h3>
          <span className="font-bold">Website:</span> {userDetails.website}
        </h3>
      </div>

      <h2 className="font-bold text-lg pb-2 border-b-2 border-primary">
        User All Posts
      </h2>
